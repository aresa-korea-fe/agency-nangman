        ...
        <div className="flex flex-row h-full">
          <div className="w-8/12 flex flex-col justify-between">
            <div className="">
              ...
              <Link href="/" className="leading-none"><h3>Portfolio</h3></Link>
              <div className="my-6 flex flex-col gap-2">
                <Link href="/portfolio/verbal-branding" className="uppercase">verbal branding</Link>
              ...
              <Link href="/project-request" className=""><h3>Project Request</h3></Link>
              <Link href="/contact-us" className=""><h3>Contact Us</h3></Link>
            </div>
            <div>
          ...
          <div className="w-4/12 border-l flex flex-col items-end justify-between text-right">
            <div>
              ...
              <div className="flex gap-3 mt-2">
                ...
                <div className="flex flex-col gap-1">
                  <div><Link href="https://www.aresa.io/" target="blank">aresa.io</Link></div>
                  <div><Link href="https://ncp.aresa.io" target="blank">ncp.aresa.io</Link></div>
                  <div><Link href="https://www.odocs.io" target="blank">odocs.io</Link></div>
                </div>
              </div>
            </div>
            <div>
